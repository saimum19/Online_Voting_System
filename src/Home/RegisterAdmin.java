...
public class RegisterAdmin extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(85, 74, 110, 37));

        jLabel2.setFont(new java.awt.Font("Trebuchet MS", 1, 14)); // NOI18N
        jLabel2.setText(" Father's Name");
        getContentPane().add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(85, 146, 110, 39));
        ...
        getContentPane().add(txtName, new org.netbeans.lib.awtextra.AbsoluteConstraints(259, 74, 220, 37));
        ...
        getContentPane().add(txtFatherName, new org.netbeans.lib.awtextra.AbsoluteConstraints(259, 146, 220, 39));
        ...
        getContentPane().add(btnRegister, new org.netbeans.lib.awtextra.AbsoluteConstraints(318, 484, 125, 36));

        jLabel3.setFont(new java.awt.Font("Trebuchet MS", 1, 14)); // NOI18N
        jLabel3.setText("  Mother's Name");
        getContentPane().add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(85, 220, 110, 41));
        getContentPane().add(txtMotherName, new org.netbeans.lib.awtextra.AbsoluteConstraints(259, 220, 220, 41));

        jLabel4.setFont(new java.awt.Font("Trebuchet MS", 1, 14)); // NOI18N
        jLabel4.setText("    Date Of Birth");
        getContentPane().add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(85, 291, 110, 32));
        ...
        getContentPane().add(txtDateOfBirth, new org.netbeans.lib.awtextra.AbsoluteConstraints(259, 291, 220, 32));

        jLabel5.setFont(new java.awt.Font("Trebuchet MS", 1, 14)); // NOI18N
        jLabel5.setText("          NID");
        getContentPane().add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(85, 356, 110, 31));
        getContentPane().add(txtNID, new org.netbeans.lib.awtextra.AbsoluteConstraints(259, 356, 220, 31));

        jLabel6.setFont(new java.awt.Font("Trebuchet MS", 1, 14)); // NOI18N
        jLabel6.setText("      Password");
        getContentPane().add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(85, 420, 110, 31));
        getContentPane().add(txtPassword, new org.netbeans.lib.awtextra.AbsoluteConstraints(258, 420, 221, 31));
        ...
        getContentPane().add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(98, 484, 121, 36));
        ...
        getContentPane().add(btnBack, new org.netbeans.lib.awtextra.AbsoluteConstraints(27, 23, -1, 33));
    ...
    private void btnRegisterActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRegisterActionPerformed
        ...
        try {
            if(txtName.getText().equals("")){
                ...
                FileWriter writer = new FileWriter("D:\\Online voting System\\LoginAdmin.txt",true);
